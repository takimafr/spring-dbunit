...
public class DefaultConfigurationConventions implements ConfigurationConventions {
    ...
    /**
     * If the supplied <code>location</code> is <code>null</code> or <em>empty</em>, a default location will be
     * {@link #getDefaultLocationByConventions(Class) generated} for the specified {@link Class class} and the
     * {@link #getResourceName resource file name} ; otherwise, the supplied <code>location</code> will be
     * {@link #modifyLocation modified} if necessary and returned.
     * 
     * @param clazz the class with which the location is associated: to be used when generating a default location
     * @param locations the raw locations to use for loading the DataSet (can be <code>null</code> or empty)
